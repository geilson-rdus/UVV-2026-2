class Produto:
    ...
    def __init__(self, codigo: int, descricao: str, preco: float) -> None:
        #A inicialização usa internamente as properties para garantir validacao
    ...
    def visualizar_quantidade_em_estoque(self) -> None:
        print(f"A quantidade do produto {self.__descricao} eh: {self.__quantidade_estoque}.")
    ...
    def codigo(self, codigo: int) -> None:
        """Setter: Permite alterar a descrica com controle."""
        if codigo <= 0:
...
if __name__ == "__main__":
    ...
    #Acesso sintático de atributo, mas execucao de metodo (Getter)
    ...
    try:
        ...
        p1.preco = -100             # dispara o ValueError do Setter
    ...
    try:
        ...
        p1.codigo = 999
        print(f"Produto: {p1.descricao} | Codigo: {p1.codigo}")
    except AttributeError:
        print("ERRO: O codigo do produto eh somente leitura (imune a alteracoes).")
